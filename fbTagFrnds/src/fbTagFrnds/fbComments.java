...
import com.codoid.products.fillo.Recordset;
	...
	public class fbComments {
		...
		public static void main(String[] args) {
			...
			drvr.findElement(By.id("email")).sendKeys("icsaran");
			drvr.findElement(By.id("pass")).sendKeys("");
			drvr.findElement(By.id("pass")).sendKeys(Keys.RETURN);
			drvr.manage().timeouts().implicitlyWait(1, TimeUnit.SECONDS);
			drvr.findElement(By.id("fbNotificationsJewel")).click();
			drvr.findElement(By.className("_33c")).click();
			drvr.findElement(By.className("blueName")).click();
			String cmt;
			drvr.manage().timeouts().implicitlyWait(1, TimeUnit.SECONDS);
			cmt = drvr.findElement(By.className(" UFICommentActorAndBody")).getText();
